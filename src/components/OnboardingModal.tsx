...
const steps = [
  {
    ...
    description: "Earn real cash by completing simple tasks, playing games, and taking surveys. It's that easy!",
  ...
  },
  {
    ...
    emoji: "🎁",
    title: "Daily Bonuses",
    description: "Login every day to collect escalating bonuses. 7 days in a row unlocks a massive $2.00 reward! Don't break your streak!",
  ...
  },
  {
    ...
    emoji: "💰",
    title: "Earn & Cashout",
    description: "Complete offers to earn cash. Withdraw anytime via PayPal, gift cards, crypto, or more — with zero fees!",
