...
const PRIZES = [
  ...
  { label: "$0.10", amount: 0.10, weight: 25 },
  { label: "$0.15", amount: 0.15, weight: 20 },
  { label: "$0.25", amount: 0.25, weight: 15 },
  { label: "$0.50", amount: 0.50, weight: 8 },
  { label: "$1.00", amount: 1.00, weight: 4 },
  { label: "$2.00", amount: 2.00, weight: 2 },
  { label: "$5.00", amount: 5.00, weight: 1 },
];
...
export async function POST() {
  ...
  // Atomically update balance, record spin, create transaction
